 ...
 * 
 */
@WebServiceClient(name = "ConvertisseurImplService", targetNamespace = "http://tp8.ws.soa.org/", wsdlLocation = "http://localhost:1234/convertisseurws?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CONVERTISSEURIMPLSERVICE_QNAME = new QName("http://tp8.ws.soa.org/", "ConvertisseurImplService");
    ...
    public Convertisseur getConvertisseurImplPort() {
        return super.getPort(new QName("http://tp8.ws.soa.org/", "ConvertisseurImplPort"), Convertisseur.class);
    }
    ...
    public Convertisseur getConvertisseurImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://tp8.ws.soa.org/", "ConvertisseurImplPort"), Convertisseur.class, features);
    }
